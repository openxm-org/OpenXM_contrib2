...
(defvar asir-exec-path asir-exec-path-default
...
(c-lang-defconst c-mode-menu 
  ...
  (append (c-lang-const c-mode-menu c)
		  '("----" 
			["Start asirgui" asir-start-asirgui (eq system-type 'windows-nt)]
			["Terminate asirgui" asir-terminate-asirgui (eq system-type 'windows-nt)]
			["Execute the current buffer on asir" asir-execute-current-buffer-on-asir 
			 (and (eq system-type 'windows-nt) (buffer-file-name))]
			["Execute the region on asir" asir-execute-region-on-asir 
