 ...
 *
 * $OpenXM: OpenXM_contrib2/asir2000/include/inline.h,v 1.9 2001/12/21 08:23:12 noro Exp $ 
*/
...
#if !defined(VISUAL) && defined(i386) && (defined(linux) || defined(__FreeBSD__) || defined(__NetBSD__) || defined(__CYGWIN__))
