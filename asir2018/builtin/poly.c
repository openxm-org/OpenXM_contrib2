...
struct ftab poly_tab[] = {
  {"headsgn",(void(*)(void))Pheadsgn,1},
  {"quo_trunc",(void(*)(void))Pquo_trunc,2},
  {"mul_trunc",(void(*)(void))Pmul_trunc,3},
  {"homogeneous_deg",(void(*)(void))Phomogeneous_deg,-2},
  {"homogeneous_part",(void(*)(void))Phomogeneous_part,-3},
  {"reorder",(void(*)(void))Preorder,3},
  {"uadj_coef",(void(*)(void))Puadj_coef,3},
  {"ranp",(void(*)(void))Pranp,2},
  {"p_mag",(void(*)(void))Pp_mag,1},
  {"maxblen",(void(*)(void))Pmaxblen,1},
  {"ord",(void(*)(void))Pord,-1},
  {"remove_vars",(void(*)(void))Premove_vars,1},
  {"delete_vars",(void(*)(void))Premove_vars,1},
  {"coef0",(void(*)(void))Pcoef0,-3},
  {"coef",(void(*)(void))Pcoef,-3},
  {"coef_gf2n",(void(*)(void))Pcoef_gf2n,2},
  {"deg",(void(*)(void))Pdeg,2},
  {"mindeg",(void(*)(void))Pmindeg,2},
  {"setmod",(void(*)(void))Psetmod,-1},

  {"sparsemod_gf2n",(void(*)(void))Psparsemod_gf2n,-1},

  {"setmod_ff",(void(*)(void))Psetmod_ff,-3},
  {"simp_ff",(void(*)(void))Psimp_ff,1},
  {"extdeg_ff",(void(*)(void))Pextdeg_ff,0},
  {"characteristic_ff",(void(*)(void))Pcharacteristic_ff,0},
  {"field_type_ff",(void(*)(void))Pfield_type_ff,0},
  {"field_order_ff",(void(*)(void))Pfield_order_ff,0},
  {"random_ff",(void(*)(void))Prandom_ff,0},
  
  {"deglist",(void(*)(void))Pdeglist,2},
  {"mergelist",(void(*)(void))Pmergelist,2},
  {"ch_mv",(void(*)(void))Pch_mv,2},
  {"re_mv",(void(*)(void))Pre_mv,2},

  {"ptomp",(void(*)(void))Pptomp,-2},
  {"mptop",(void(*)(void))Pmptop,1},

  {"ptolmp",(void(*)(void))Pptolmp,1},
  {"lmptop",(void(*)(void))Plmptop,1},

  {"sf_galois_action",(void(*)(void))Psf_galois_action,2},
  {"sf_find_root",(void(*)(void))Psf_find_root,1},
  {"sf_minipoly",(void(*)(void))Psf_minipoly,2},
  {"sf_embed",(void(*)(void))Psf_embed,3},
  {"sf_log",(void(*)(void))Psf_log,1},

  {"ptosfp",(void(*)(void))Pptosfp,1},
  {"sfptop",(void(*)(void))Psfptop,1},
  {"sfptopsfp",(void(*)(void))Psfptopsfp,2},
  {"ptogf2n",(void(*)(void))Pptogf2n,1},
  {"gf2ntop",(void(*)(void))Pgf2ntop,-2},
  {"gf2ntovect",(void(*)(void))Pgf2ntovect,1},

  {"ptogfpn",(void(*)(void))Pptogfpn,1},
  {"gfpntop",(void(*)(void))Pgfpntop,-2},

  {"kmul",(void(*)(void))Pkmul,2},
  {"ksquare",(void(*)(void))Pksquare,1},
  {"ktmul",(void(*)(void))Pktmul,3},

  {"umul",(void(*)(void))Pumul,2},
  {"usquare",(void(*)(void))Pusquare,1},
  {"ureverse_inv_as_power_series",(void(*)(void))Purevinvmod,2},
  {"uinv_as_power_series",(void(*)(void))Puinvmod,2},

  {"umul_specialmod",(void(*)(void))Pumul_specialmod,3},
  {"usquare_specialmod",(void(*)(void))Pusquare_specialmod,2},
  {"utmul_specialmod",(void(*)(void))Putmul_specialmod,4},

  {"utmul",(void(*)(void))Putmul,3},
  {"umul_ff",(void(*)(void))Pumul_ff,2},
  {"usquare_ff",(void(*)(void))Pusquare_ff,1},
  {"utmul_ff",(void(*)(void))Putmul_ff,3},

  /* for historical reason */
  {"trunc",(void(*)(void))Putrunc,2},
  {"decomp",(void(*)(void))Pudecomp,2},

  {"utrunc",(void(*)(void))Putrunc,2},
  {"udecomp",(void(*)(void))Pudecomp,2},
  {"ureverse",(void(*)(void))Pureverse,-2},
  {"urembymul",(void(*)(void))Purembymul,2},
  {"urembymul_precomp",(void(*)(void))Purembymul_precomp,3},

  {"lazy_lm",(void(*)(void))Plazy_lm,1},
  {"lazy_ff",(void(*)(void))Plazy_lm,1},

  {"pwrmod_ff",(void(*)(void))Ppwrmod_ff,1},
  {"generic_pwrmod_ff",(void(*)(void))Pgeneric_pwrmod_ff,3},
  {"pwrtab_ff",(void(*)(void))Ppwrtab_ff,2},

  {"tracemod_gf2n",(void(*)(void))Ptracemod_gf2n,3},
  {"b_find_root_gf2n",(void(*)(void))Pfind_root_gf2n,1},

  {"is_irred_gf2",(void(*)(void))Pis_irred_gf2,1},
  {"is_irred_ddd_gf2",(void(*)(void))Pis_irred_ddd_gf2,1},

  {"kpwrmod_lm",(void(*)(void))Pkpwrmod_lm,1},
  {"kgeneric_pwrmod_lm",(void(*)(void))Pkgeneric_pwrmod_lm,3},
  {"kpwrtab_lm",(void(*)(void))Pkpwrtab_lm,2},

  {"kmulum",(void(*)(void))Pkmulum,3},
  {"ksquareum",(void(*)(void))Pksquareum,2},

  {"fmultest",(void(*)(void))Pfmultest,3},
  {"hfmul_lm",(void(*)(void))Phfmul_lm,2},

  {"multest_gf2n",(void(*)(void))Pmultest_gf2n,2},
  {"squaretest_gf2n",(void(*)(void))Psquaretest_gf2n,1},
  {"bininv_gf2n",(void(*)(void))Pbininv_gf2n,2},
  {"invtest_gf2n",(void(*)(void))Pinvtest_gf2n,1},
  {"rinvtest_gf2n",(void(*)(void))Prinvtest_gf2n,0},
  {"get_next_fft_prime",(void(*)(void))Pget_next_fft_prime,2},
  {0,0,0},
};
