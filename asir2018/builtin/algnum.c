...
struct ftab alg_tab[] = {
  {"set_field",(void(*)(void))Pset_field,-3},
  {"get_field_defpoly",(void(*)(void))Pget_field_defpoly,1},
  {"get_field_generator",(void(*)(void))Pget_field_generator,1},
  {"algtodalg",(void(*)(void))Palgtodalg,1},
  {"dalgtoalg",(void(*)(void))Pdalgtoalg,1},
  {"dalgtodp",(void(*)(void))Pdalgtodp,1},
  {"dalgtoup",(void(*)(void))Pdalgtoup,1},
  {"dptodalg",(void(*)(void))Pdptodalg,1},
  {"inv_or_split_dalg",(void(*)(void))Pinv_or_split_dalg,1},
  {"invalg_chrem",(void(*)(void))Pinvalg_chrem,2},
  {"invalg_le",(void(*)(void))Pinvalg_le,1},
  {"defpoly",(void(*)(void))Pdefpoly,1},
  {"newalg",(void(*)(void))Pnewalg,1},
  {"mainalg",(void(*)(void))Pmainalg,1},
  {"algtorat",(void(*)(void))Palgtorat,1},
  {"rattoalg",(void(*)(void))Prattoalg,1},
  {"getalg",(void(*)(void))Pgetalg,1},
  {"getalgtree",(void(*)(void))Pgetalgtree,1},
  {"alg",(void(*)(void))Palg,1},
  {"algv",(void(*)(void))Palgv,1},
  {0,0,0},
};
...
void invalg_le(Alg a,LIST *r)
{
  ...
  P p,dn,ap;
  VL vl,tvl;
  Q c1,c2,c3,cont,c,mul;
  Z two,iq,dn0,dn1,dnsol;
  int i,j,n,len,k;
  MP mp,mp0;
