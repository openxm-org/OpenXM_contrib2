...
struct ftab dp_tab[] = {
  /* content reduction */
  {"dp_ptozp",(void(*)(void))Pdp_ptozp,1},
  {"dp_ptozp2",(void(*)(void))Pdp_ptozp2,2},
  {"dp_prim",(void(*)(void))Pdp_prim,1},
  {"dp_red_coef",(void(*)(void))Pdp_red_coef,2},
  {"dp_cont",(void(*)(void))Pdp_cont,1},
  {"dpm_ptozp",(void(*)(void))Pdpm_ptozp,1},
  {"dpm_remove_cont",(void(*)(void))Pdpm_remove_cont,1},
  {"dpm_prim",(void(*)(void))Pdpm_prim,1},
  {"dpm_pos",(void(*)(void))Pdpm_pos,1},

/* polynomial ring */
  /* special operations */
  {"dp_mul_trunc",(void(*)(void))Pdp_mul_trunc,3},
  {"dp_quo",(void(*)(void))Pdp_quo,2},

  /* s-poly */
  {"dp_sp",(void(*)(void))Pdp_sp,2},
  {"dp_sp_mod",(void(*)(void))Pdp_sp_mod,3},

  /* m-reduction */
  {"dp_red",(void(*)(void))Pdp_red,3},
  {"dp_red_mod",(void(*)(void))Pdp_red_mod,4},

  /* normal form */
  {"dp_nf",(void(*)(void))Pdp_nf,4},
  {"dp_nf_mod",(void(*)(void))Pdp_nf_mod,5},
  {"dp_nf_f",(void(*)(void))Pdp_nf_f,4},
  {"dpm_nf_and_quotient",(void(*)(void))Pdpm_nf_and_quotient,-3},
  {"dpm_nf_and_quotient2",(void(*)(void))Pdpm_nf_and_quotient2,-3},
  {"dpm_nf_f",(void(*)(void))Pdpm_nf_f,-4},
  {"dpm_weyl_nf_f",(void(*)(void))Pdpm_weyl_nf_f,-4},
  {"dpm_nf",(void(*)(void))Pdpm_nf,-4},
  {"dpm_sp",(void(*)(void))Pdpm_sp,2},
  {"dpm_weyl_sp",(void(*)(void))Pdpm_weyl_sp,2},

  {"dp_true_nf",(void(*)(void))Pdp_true_nf,4},
  {"dp_true_nf_mod",(void(*)(void))Pdp_true_nf_mod,5},
  {"dp_true_nf_marked",(void(*)(void))Pdp_true_nf_marked,4},
  {"dp_true_nf_marked_check",(void(*)(void))Pdp_true_nf_marked_check,4},
  {"dp_true_nf_marked_check_mod",(void(*)(void))Pdp_true_nf_marked_check_mod,5},
  {"dp_true_nf_marked_mod",(void(*)(void))Pdp_true_nf_marked_mod,5},
  {"dp_true_lnf",(void(*)(void))Pdp_true_lnf,-3},
  {"dp_true_lnf_mod",(void(*)(void))Pdp_true_lnf_mod,-4},

  {"dp_true_nf_and_quotient",(void(*)(void))Pdp_true_nf_and_quotient,3},
  {"dp_true_nf_and_quotient_mod",(void(*)(void))Pdp_true_nf_and_quotient_mod,4},
  {"dp_true_nf_and_quotient_marked",(void(*)(void))Pdp_true_nf_and_quotient_marked,4},
  {"dp_true_nf_and_quotient_marked_mod",(void(*)(void))Pdp_true_nf_and_quotient_marked_mod,5},

  {"dp_lnf_mod",(void(*)(void))Pdp_lnf_mod,3},
  {"dp_nf_tab_f",(void(*)(void))Pdp_nf_tab_f,2},
  {"dp_nf_tab_mod",(void(*)(void))Pdp_nf_tab_mod,3},
  {"dp_lnf_f",(void(*)(void))Pdp_lnf_f,2},

  /* Buchberger algorithm */
  {"dp_gr_main",(void(*)(void))Pdp_gr_main,-5},
  {"dp_interreduce",(void(*)(void))Pdp_interreduce,3},
  {"dp_gr_mod_main",(void(*)(void))Pdp_gr_mod_main,5},
  {"dp_gr_f_main",(void(*)(void))Pdp_gr_f_main,4},
  {"dp_gr_checklist",(void(*)(void))Pdp_gr_checklist,2},
  {"nd_f4",(void(*)(void))Pnd_f4,-4},
  {"nd_gr",(void(*)(void))Pnd_gr,-4},
  {"nd_sba",(void(*)(void))Pnd_sba,-4},
  {"nd_weyl_sba",(void(*)(void))Pnd_weyl_sba,-4},
#if !defined(VISUAL)
  {"nd_sba_f4",(void(*)(void))Pnd_sba_f4,-4},
#endif
  {"nd_gr_trace",(void(*)(void))Pnd_gr_trace,-5},
  {"nd_f4_trace",(void(*)(void))Pnd_f4_trace,-5},
  {"nd_gr_postproc",(void(*)(void))Pnd_gr_postproc,5},
  {"nd_gr_recompute_trace",(void(*)(void))Pnd_gr_recompute_trace,5},
  {"nd_btog",(void(*)(void))Pnd_btog,-6},
  {"nd_weyl_gr_postproc",(void(*)(void))Pnd_weyl_gr_postproc,5},
  {"nd_weyl_gr",(void(*)(void))Pnd_weyl_gr,-4},
  {"nd_weyl_gr_trace",(void(*)(void))Pnd_weyl_gr_trace,-5},
  {"nd_nf",(void(*)(void))Pnd_nf,5},
  {"nd_weyl_nf",(void(*)(void))Pnd_weyl_nf,5},

  /* F4 algorithm */
  {"dp_f4_main",(void(*)(void))Pdp_f4_main,3},
  {"dp_f4_mod_main",(void(*)(void))Pdp_f4_mod_main,4},

/* weyl algebra */
  /* multiplication */
  {"dp_weyl_mul",(void(*)(void))Pdp_weyl_mul,2},
  {"dp_weyl_mul_mod",(void(*)(void))Pdp_weyl_mul_mod,3},
  {"dp_weyl_act",(void(*)(void))Pdp_weyl_act,2},

  /* s-poly */
  {"dp_weyl_sp",(void(*)(void))Pdp_weyl_sp,2},

  /* m-reduction */
  {"dp_weyl_red",(void(*)(void))Pdp_weyl_red,3},

  /* normal form */
  {"dp_weyl_nf",(void(*)(void))Pdp_weyl_nf,4},
  {"dpm_weyl_nf",(void(*)(void))Pdpm_weyl_nf,-4},
  {"dp_weyl_nf_mod",(void(*)(void))Pdp_weyl_nf_mod,5},
  {"dp_weyl_nf_f",(void(*)(void))Pdp_weyl_nf_f,4},

  {"dp_weyl_true_nf_and_quotient",(void(*)(void))Pdp_weyl_true_nf_and_quotient,3},
  {"dp_weyl_true_nf_and_quotient_mod",(void(*)(void))Pdp_weyl_true_nf_and_quotient_mod,4},
  {"dp_weyl_true_nf_and_quotient_marked",(void(*)(void))Pdp_weyl_true_nf_and_quotient_marked,4},
  {"dp_weyl_true_nf_and_quotient_marked_mod",(void(*)(void))Pdp_weyl_true_nf_and_quotient_marked_mod,5},


  /* Buchberger algorithm */
  {"dp_weyl_gr_main",(void(*)(void))Pdp_weyl_gr_main,-5},
  {"dp_weyl_gr_mod_main",(void(*)(void))Pdp_weyl_gr_mod_main,5},
  {"dp_weyl_gr_f_main",(void(*)(void))Pdp_weyl_gr_f_main,4},

  /* F4 algorithm */
  {"dp_weyl_f4_main",(void(*)(void))Pdp_weyl_f4_main,3},
  {"dp_weyl_f4_mod_main",(void(*)(void))Pdp_weyl_f4_mod_main,4},
  {"dp_symb_preproc",(void(*)(void))Pdp_symb_preproc,-3},

  /* Hilbert function */
  {"dp_monomial_hilbert_poincare",(void(*)(void))Pdp_monomial_hilbert_poincare,2},
  {"dp_monomial_hilbert_poincare_incremental",(void(*)(void))Pdp_monomial_hilbert_poincare_incremental,3},

  /* misc */
  {"dp_inv_or_split",(void(*)(void))Pdp_inv_or_split,3},
  {"dp_set_weight",(void(*)(void))Pdp_set_weight,-1},
  {"dp_set_module_weight",(void(*)(void))Pdp_set_module_weight,-1},
  {"dp_set_top_weight",(void(*)(void))Pdp_set_top_weight,-1},
  {"dp_weyl_set_weight",(void(*)(void))Pdp_weyl_set_weight,-1},

  {"dp_get_denomlist",(void(*)(void))Pdp_get_denomlist,0},
  {0,0,0},
};

struct ftab dp_supp_tab[] = {
  /* setting flags */
  {"dp_sort",(void(*)(void))Pdp_sort,1},
  {"dp_ord",(void(*)(void))Pdp_ord,-1},
  {"dpm_set_schreyer",(void(*)(void))Pdpm_set_schreyer,-1},
  {"dpm_set_schreyer_level",(void(*)(void))Pdpm_set_schreyer_level,1},
  {"dpm_schreyer_frame",(void(*)(void))Pdpm_schreyer_frame,1},
  {"dpv_ord",(void(*)(void))Pdpv_ord,-2},
  {"dp_set_kara",(void(*)(void))Pdp_set_kara,-1},
  {"dp_nelim",(void(*)(void))Pdp_nelim,-1},
  {"dp_gr_flags",(void(*)(void))Pdp_gr_flags,-1},
  {"dp_gr_print",(void(*)(void))Pdp_gr_print,-1},

  /* converters */
  {"homogenize",(void(*)(void))Phomogenize,3},
  {"dp_ptod",(void(*)(void))Pdp_ptod,-2},
  {"dp_dtop",(void(*)(void))Pdp_dtop,2},
  {"dp_homo",(void(*)(void))Pdp_homo,1},
  {"dp_dehomo",(void(*)(void))Pdp_dehomo,1},
  {"dp_etov",(void(*)(void))Pdp_etov,1},
  {"dp_vtoe",(void(*)(void))Pdp_vtoe,1},
  {"dp_dtov",(void(*)(void))Pdp_dtov,1},
  {"dp_mdtod",(void(*)(void))Pdp_mdtod,1},
  {"dp_mod",(void(*)(void))Pdp_mod,3},
  {"dp_rat",(void(*)(void))Pdp_rat,1},
  {"dp_ltod",(void(*)(void))Pdp_ltod,-2},

  {"dpm_ltod",(void(*)(void))Pdpm_ltod,2},
  {"dpm_dptodpm",(void(*)(void))Pdpm_dptodpm,2},
  {"dpm_dtol",(void(*)(void))Pdpm_dtol,2},
  {"dpm_homo",(void(*)(void))Pdpm_homo,1},
  {"dpm_dehomo",(void(*)(void))Pdpm_dehomo,1},
  {"dpm_mod",(void(*)(void))Pdpm_mod,2},

  /* criteria */
  {"dp_cri1",(void(*)(void))Pdp_cri1,2},
  {"dp_cri2",(void(*)(void))Pdp_cri2,2},
  {"dp_criB",(void(*)(void))Pdp_criB,3},

  /* simple operation */
  {"dp_subd",(void(*)(void))Pdp_subd,2},
  {"dp_lcm",(void(*)(void))Pdp_lcm,2},
  {"dp_hm",(void(*)(void))Pdp_hm,1},
  {"dp_ht",(void(*)(void))Pdp_ht,1},
  {"dp_hc",(void(*)(void))Pdp_hc,1},
  {"dpv_hm",(void(*)(void))Pdpv_hm,1},
  {"dpv_ht",(void(*)(void))Pdpv_ht,1},
  {"dpv_hc",(void(*)(void))Pdpv_hc,1},
  {"dpm_hm",(void(*)(void))Pdpm_hm,1},
  {"dpm_ht",(void(*)(void))Pdpm_ht,1},
  {"dpm_hc",(void(*)(void))Pdpm_hc,1},
  {"dpm_hp",(void(*)(void))Pdpm_hp,1},
  {"dpm_rest",(void(*)(void))Pdpm_rest,1},
  {"dpm_shift",(void(*)(void))Pdpm_shift,2},
  {"dpm_split",(void(*)(void))Pdpm_split,2},
  {"dpm_extract",(void(*)(void))Pdpm_extract,2},
  {"dpm_sort",(void(*)(void))Pdpm_sort,1},
  {"dp_rest",(void(*)(void))Pdp_rest,1},
  {"dp_initial_term",(void(*)(void))Pdp_initial_term,1},
  {"dp_order",(void(*)(void))Pdp_order,1},
  {"dp_symb_add",(void(*)(void))Pdp_symb_add,2},

  /* degree and size */
  {"dp_td",(void(*)(void))Pdp_td,1},
  {"dp_mag",(void(*)(void))Pdp_mag,1},
  {"dp_sugar",(void(*)(void))Pdp_sugar,1},
  {"dp_set_sugar",(void(*)(void))Pdp_set_sugar,2},
  {"dpm_td",(void(*)(void))Pdpm_td,1},

  /* misc */
  {"dp_mbase",(void(*)(void))Pdp_mbase,1},
  {"dp_redble",(void(*)(void))Pdp_redble,2},
  {"dpm_redble",(void(*)(void))Pdpm_redble,2},
  {"dp_sep",(void(*)(void))Pdp_sep,2},
  {"dp_idiv",(void(*)(void))Pdp_idiv,2},
  {"dp_tdiv",(void(*)(void))Pdp_tdiv,2},
  {"dp_minp",(void(*)(void))Pdp_minp,2},
  {"dp_compute_last_w",(void(*)(void))Pdp_compute_last_w,5},
  {"dp_compute_last_w_02",(void(*)(void))Pdp_compute_last_w_02,3},
  {"dp_compute_last_t",(void(*)(void))Pdp_compute_last_t,5},
  {"dp_compute_essential_df",(void(*)(void))Pdp_compute_essential_df,2},
  {"dp_mono_raddec",(void(*)(void))Pdp_mono_raddec,2},
  {"dp_mono_reduce",(void(*)(void))Pdp_mono_reduce,2},
  {"dpm_schreyer_base",(void(*)(void))Pdpm_schreyer_base,1},
  {"dpm_list_to_array",(void(*)(void))Pdpm_list_to_array,1},
  {"dpm_sp_nf",(void(*)(void))Pdpm_sp_nf,4},
  {"dpm_insert_to_zlist",(void(*)(void))Pdpm_insert_to_zlist,3},
  {"dpm_simplify_syz",(void(*)(void))Pdpm_simplify_syz,2},

  {"dp_rref2",(void(*)(void))Pdp_rref2,2},
  {"sumi_updatepairs",(void(*)(void))Psumi_updatepairs,3},
  {"sumi_symbolic",(void(*)(void))Psumi_symbolic,5},
...
void Pdp_true_nf_marked_check(NODE arg,LIST *rp)
{
  ...
  do_weyl = 0; dp_fcoeffs = 0;
  asir_assert(ARG0(arg),O_LIST,"dp_true_nf_marked_check");
  asir_assert(ARG1(arg),O_DP,"dp_true_nf_marked_check");
  asir_assert(ARG2(arg),O_VECT,"dp_true_nf_marked_check");
  asir_assert(ARG3(arg),O_VECT,"dp_true_nf_marked_check");
  if ( !(g = (DP)ARG1(arg)) ) {
    nm = 0; dn = (P)ONE;
  } else {
    b = BDY((LIST)ARG0(arg)); 
  ...
  int *modular,struct order_spec **ord)
{
  ...
  for ( t = opt; t; t = NEXT(t) ) {
    ...
    if ( !strcmp(key,"v") ) {
      ...
      /* weight */
      Pdp_set_weight(NEXT(p),(VECT *)&dmy);
