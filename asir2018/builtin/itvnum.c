...
struct ftab interval_tab[] = {
  {"printmode",(void(*)(void))Pprintmode,1},
#if defined(INTERVAL)
  {"itvd",(void(*)(void))Pitvd,-2},
  {"intvald",(void(*)(void))Pitvd,-2},
  {"itv",(void(*)(void))Pitv,-2},
  {"intval",(void(*)(void))Pitv,-2},
  {"itvbf",(void(*)(void))Pitvbf,-2},
  {"intvalbf",(void(*)(void))Pitvbf,-2},
  {"inf",(void(*)(void))Pinf,1},
  {"sup",(void(*)(void))Psup,1},
  {"absintval",(void(*)(void))Pabsitv,1},
  {"absitv",(void(*)(void))Pabsitv,1},
  {"disintval",(void(*)(void))Pdisjitv,2},
  {"inintval",(void(*)(void))Pinitv,2},
  {"cup",(void(*)(void))Pcup,2},
  {"cap",(void(*)(void))Pcap,2},
  {"mid",(void(*)(void))Pmid,1},
  {"width",(void(*)(void))Pwidth,1},
  {"diam",(void(*)(void))Pwidth,1},
  {"distance",(void(*)(void))Pdistance,2},
  {"iversion",(void(*)(void))Pitvversion,-1},
  {"intvalversion",(void(*)(void))Pitvversion,-1},
  {"zerorewritemode",(void(*)(void))PzeroRewriteMode,-1},
  {"zeroRewriteMode",(void(*)(void))PzeroRewriteMode,-1},
  {"zeroRewriteCountClear",(void(*)(void))PzeroRewriteCountClear,-1},
  {"zeroRewriteCount",(void(*)(void))PzeroRewriteCount,-1},
/* eval */
  {"evalitv", 	(void(*)(void))Pevalitv,	-2},
  {"evalitvbf",	(void(*)(void))Pevalitvbf,	-2},
  {"evalitvd",	(void(*)(void))Pevalitvd,	1},
/* math */

  {"piitv",		(void(*)(void))Pitv_pi,	-1},
  {"piitvbf",	(void(*)(void))Pitvbf_pi,	-1},
  {"piitvd",	(void(*)(void))Pitvd_pi,	-1},
  {"eitv",		(void(*)(void))Pitv_e,	-1},
  {"eitvbf",	(void(*)(void))Pitvbf_e,	-1},
  {"eitvd",		(void(*)(void))Pitvd_e,	-1},
#if 0
  {"factorialitv",(void(*)(void))Pfactorialitv,1},
  {"factorialitvd",(void(*)(void))Pfactorialitvd,1},

  {"absitv",	(void(*)(void))Pitv_abs,	-2},
  {"absitvbf",	(void(*)(void))Pitvbf_abs,	-2},
  {"absitvd",	(void(*)(void))Pitvd_abs,	-2},
#endif

  {"logitv",	(void(*)(void))Pitv_log,	-2},
  {"logitvbf",	(void(*)(void))Pitvbf_log,	-2},
  {"logitvd",	(void(*)(void))Pitvd_log,	-2},
  {"expitv",	(void(*)(void))Pitv_exp,	-2},
  {"expitvbf",	(void(*)(void))Pitvbf_exp,	-2},
  {"expitvd",	(void(*)(void))Pitvd_exp,	-2},
  {"powitv",	(void(*)(void))Pitv_pow,	-3},
  {"powitvbf",	(void(*)(void))Pitvbf_pow,	-3},
  {"powitvd",	(void(*)(void))Pitvd_pow,	-3},

  {"sinitv",	(void(*)(void))Pitv_sin,	-2},
  {"sinitvbf",	(void(*)(void))Pitvbf_sin,	-2},
  {"sinitvd",	(void(*)(void))Pitvd_sin,	-2},
  {"cositv",	(void(*)(void))Pitv_cos,	-2},
  {"cositvbf",	(void(*)(void))Pitvbf_cos,	-2},
  {"cositvd",	(void(*)(void))Pitvd_cos,	-2},
  {"tanitv",	(void(*)(void))Pitv_tan,	-2},
  {"tanitvbf",	(void(*)(void))Pitvbf_tan,	-2},
  {"tanitvd",	(void(*)(void))Pitvd_tan,	-2},
  {"asinitv",	(void(*)(void))Pitv_asin,	-2},
  {"asinitvbf",	(void(*)(void))Pitvbf_asin,	-2},
  {"asinitvd",	(void(*)(void))Pitvd_asin,		-2},
  {"acositv",	(void(*)(void))Pitv_acos,		-2},
  {"acositvbf",	(void(*)(void))Pitvbf_acos,	-2},
  {"acositvd",	(void(*)(void))Pitvd_acos,		-2},
  {"atanitv",	(void(*)(void))Pitv_atan,		-2},
  {"atanitvbf",	(void(*)(void))Pitvbf_atan,	-2},
  {"atanitvd",	(void(*)(void))Pitvd_atan,		-2},
  {"sinhitv",	(void(*)(void))Pitv_sinh,		-2},
  {"sinhitvbf",	(void(*)(void))Pitvbf_sinh,	-2},
  {"sinhitvd",	(void(*)(void))Pitvd_sinh,		-2},
  {"coshitv",	(void(*)(void))Pitv_cosh,		-2},
  {"coshitvbf",	(void(*)(void))Pitvbf_cosh,	-2},
  {"coshitvd",	(void(*)(void))Pitvd_cosh,		-2},
  {"tanhitv",	(void(*)(void))Pitv_tanh,		-2},
  {"tanhitvbf",	(void(*)(void))Pitvbf_tanh,	-2},
  {"tanhitvd",	(void(*)(void))Pitvd_tanh,		-2},
  {"asinhitv",	(void(*)(void))Pitv_asinh,		-2},
  {"asinhitvbf",	(void(*)(void))Pitvbf_asinh,	-2},
  {"asinhitvd",		(void(*)(void))Pitvd_asinh,	-2},
  {"acoshitv",		(void(*)(void))Pitv_acosh,		-2},
  {"acoshitvbf",	(void(*)(void))Pitvbf_acosh,	-2},
  {"acoshitvd",		(void(*)(void))Pitvd_acosh,	-2},
  {"atanhitv",		(void(*)(void))Pitv_atanh,		-2},
  {"atanhitvbf",	(void(*)(void))Pitvbf_atanh,	-2},
  {"atanhitvd",		(void(*)(void))Pitvd_atanh,	-2},

/* plot time check */
  {"ifcheck",(void(*)(void))Pifcheck,-7},
#endif
  {0,0,0},
};
