...
struct ftab str_tab[] = {
  {"sprintf",(void(*)(void))Psprintf,-99999999},
  {"rtostr",(void(*)(void))Prtostr,1},
  {"strtov",(void(*)(void))Pstrtov,1},
  {"eval_str",(void(*)(void))Peval_str,1},
  {"strtoascii",(void(*)(void))Pstrtoascii,1},
  {"asciitostr",(void(*)(void))Pasciitostr,1},
  {"str_len",(void(*)(void))Pstr_len,1},
  {"str_chr",(void(*)(void))Pstr_chr,3},
  {"sub_str",(void(*)(void))Psub_str,3},
  {"write_to_tb",(void(*)(void))Pwrite_to_tb,2},
  {"clear_tb",(void(*)(void))Pclear_tb,1},
  {"tb_to_string",(void(*)(void))Ptb_to_string,1},
  {"string_to_tb",(void(*)(void))Pstring_to_tb,1},
  {"get_quote_id",(void(*)(void))Pget_quote_id,1},

  {"qt_is_var",(void(*)(void))Pqt_is_var,1},
  {"qt_is_coef",(void(*)(void))Pqt_is_coef,1},
  {"qt_is_number",(void(*)(void))Pqt_is_number,1},
  {"qt_is_rational",(void(*)(void))Pqt_is_rational,1},
  {"qt_is_integer",(void(*)(void))Pqt_is_integer,1},
  {"qt_is_function",(void(*)(void))Pqt_is_function,1},
  {"qt_is_dependent",(void(*)(void))Pqt_is_dependent,2},

  {"qt_set_coef",(void(*)(void))Pqt_set_coef,-1},
  {"qt_set_ord",(void(*)(void))Pqt_set_ord,-1},
  {"qt_set_weight",(void(*)(void))Pqt_set_weight,-1},
  {"qt_normalize",(void(*)(void))Pqt_normalize,-2},
  {"qt_match",(void(*)(void))Pqt_match,2},
  {"nqt_match_rewrite",(void(*)(void))Pnqt_match_rewrite,3},

  {"nqt_weight",(void(*)(void))Pnqt_weight,1},
  {"nqt_comp",(void(*)(void))Pnqt_comp,2},
  {"nqt_match",(void(*)(void))Pnqt_match,-3},
  {"qt_to_nbp",(void(*)(void))Pqt_to_nbp,1},
  {"shuffle_mul",(void(*)(void))Pshuffle_mul,2},
  {"harmonic_mul",(void(*)(void))Pharmonic_mul,2},

  {"nbp_hm",(void(*)(void))Pnbp_hm,1},
  {"nbp_ht",(void(*)(void))Pnbp_ht,1},
  {"nbp_hc",(void(*)(void))Pnbp_hc,1},
  {"nbp_rest",(void(*)(void))Pnbp_rest,1},
  {"nbp_tm",(void(*)(void))Pnbp_tm,1},
  {"nbp_tt",(void(*)(void))Pnbp_tt,1},
  {"nbp_tc",(void(*)(void))Pnbp_tc,1},
  {"nbp_trest",(void(*)(void))Pnbp_trest,1},
  {"nbm_deg",(void(*)(void))Pnbm_deg,1},
  {"nbm_index",(void(*)(void))Pnbm_index,1},
  {"nbm_hxky",(void(*)(void))Pnbm_hxky,1},
  {"nbm_xky_rest",(void(*)(void))Pnbm_xky_rest,1},
  {"nbm_hp_rest",(void(*)(void))Pnbm_hp_rest,1},
  {"nbm_hv",(void(*)(void))Pnbm_hv,1},
  {"nbm_tv",(void(*)(void))Pnbm_tv,1},
  {"nbm_rest",(void(*)(void))Pnbm_rest,1},
  {"nbm_trest",(void(*)(void))Pnbm_trest,1},

  {"qt_to_nary",(void(*)(void))Pqt_to_nary,1},
  {"qt_to_bin",(void(*)(void))Pqt_to_bin,2},

  {"quotetotex_tb",(void(*)(void))Pquotetotex_tb,2},
  {"quotetotex",(void(*)(void))Pquotetotex,1},
  {"quotetotex_env",(void(*)(void))Pquotetotex_env,-99999999},
  {"flatten_quote",(void(*)(void))Pflatten_quote,-2},
  {"quote_to_funargs",(void(*)(void))Pquote_to_funargs,1},
  {"funargs_to_quote",(void(*)(void))Pfunargs_to_quote,1},
  {"get_function_name",(void(*)(void))Pget_function_name,1},
  {0,0,0},
};
...
FNODE fnode_normalize(FNODE f,int expand)
{
  ...
  switch ( f->id ) {
    ...
    default:
      return fnode_apply(f,(FNODE (*)(FNODE,int))fnode_normalize,expand);
  }
  r->normalized = 1;
  r->expanded = expand;
  return r;
