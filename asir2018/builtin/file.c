...
struct ftab file_tab[] = {
  {"fprintf",(void(*)(void))Pfprintf,-99999999},
  {"purge_stdin",(void(*)(void))Ppurge_stdin,0},
  {"open_file",(void(*)(void))Popen_file,-2},
  {"close_file",(void(*)(void))Pclose_file,1},
  {"get_byte",(void(*)(void))Pget_byte,1},
  {"put_byte",(void(*)(void))Pput_byte,2},
  {"get_word",(void(*)(void))Pget_word,1},
  {"put_word",(void(*)(void))Pput_word,2},
  {"get_line",(void(*)(void))Pget_line,-1},
  {"remove_file",(void(*)(void))Premove_file,1},
  {"access",(void(*)(void))Paccess,1},
  {"load",(void(*)(void))Pload,-1},
  {"import",(void(*)(void))Pimport,-1},
  {"which",(void(*)(void))Pwhich,1},
  {"loadfiles",(void(*)(void))Ploadfiles,1},
  {"output",(void(*)(void))Poutput,-1},
  {"bsave",(void(*)(void))Pbsave,2},
  {"bload",(void(*)(void))Pbload,1},
  {"get_rootdir",(void(*)(void))Pget_rootdir,0},
#if defined(DES_ENC)
  {"bsave_enc",(void(*)(void))Pbsave_enc,2},
  {"bload_enc",(void(*)(void))Pbload_enc,1},
#endif
  {"bsave_cmo",(void(*)(void))Pbsave_cmo,2},
  {"bload_cmo",(void(*)(void))Pbload_cmo,1},
  {"getpid",(void(*)(void))Pgetpid,0},
  {0,0,0},
};
