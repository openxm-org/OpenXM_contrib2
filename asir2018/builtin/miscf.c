...
struct ftab misc_tab[] = {
  {"pwd",(void(*)(void))Pgetcwd,0},
  {"chdir",(void(*)(void))Pchdir,1},
  {"set_secure_mode",(void(*)(void))Pset_secure_mode,-1},
  {"set_secure_flag",(void(*)(void))Pset_secure_flag,-2},
  {"module_list",(void(*)(void))Pmodule_list,0},
  {"remove_module",(void(*)(void))Premove_module,1},
  {"module_definedp",(void(*)(void))Pmodule_definedp,1},
  {"sleep",(void(*)(void))Psleep,1},
  {"null_command",(void(*)(void))Pnull_command,-99999},
  {"getenv",(void(*)(void))Pgetenv,1},
  {"end",(void(*)(void))Pquit,0},
  {"quit",(void(*)(void))Pquit,0},
  {"debug",(void(*)(void))Pdebug,0},
  {"shell",(void(*)(void))Pshell,-2},
  {"heap",(void(*)(void))Pheap,-1},
  {"version",(void(*)(void))Pversion,-99999},
  {"copyright",(void(*)(void))Pcopyright,0},
  {"nmono",(void(*)(void))Pnmono,1},
  {"toplevel",(void(*)(void))Ptoplevel,-1},
  {"error",(void(*)(void))Perror,1},
  {"error3",(void(*)(void))Perror3,3},
  {"nez",(void(*)(void))Pnez,1},
  {"flist",(void(*)(void))Pflist,-1},
  {"delete_history",(void(*)(void))Pdelete_history,-2},
  {"pause",(void(*)(void))Ppause,0},
  {"gc",(void(*)(void))Pgc,0},
  {"batch",(void(*)(void))Pbatch,2},
  {"send_progress",(void(*)(void))Psend_progress,-2},
  {"get_addr",(void(*)(void))Pget_addr,1},
  {"hex_dump",(void(*)(void))Phex_dump,2},
  {"peek",(void(*)(void))Ppeek,1},
  {"poke",(void(*)(void))Ppoke,2},
#if !defined(VISUAL) && defined(DO_PLOT)
  {"xpause",(void(*)(void))Pxpause,0},
#endif
#if 0
  {"opt",(void(*)(void))Popt,1},
#endif
  {0,0,0},
};
