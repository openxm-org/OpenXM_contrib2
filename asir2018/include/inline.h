 ...
 *
 * $OpenXM: OpenXM_contrib2/asir2018/include/inline.h,v 1.1 2018/09/19 06:00:58 noro Exp $
*/
...
#if defined(__GNUC__) || defined(__INTEL_COMPILER) || defined(__alpha) || defined(mips) || defined(_IBMR2) || defined(_WIN64)
#define DM(a1,a2,u,l)\
{UL _t;\
_t=(UL)(a1)*(UL)(a2);\
